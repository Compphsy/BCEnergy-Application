          ...
          if (usages.length > 0) {
            ...
            usages.forEach((reading, index) => {
              ...
              if (index > 0) {
                ...
                var contractData = [[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],[lastTime,avePower],];
                console.log(contractData);
                  }
        // add the energy usage data to the blockchain
        const transaction = await contract.addEnergyData(contractData, { value: ethers.utils.parseEther(amount) });
